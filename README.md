...
It shows what installed each skill, where from, when, and when the skill last
changed on GitHub, so you can see which ones have a newer version. Skills that
were copied in by hand have no record of where they came from, so those
columns are `NA`.
